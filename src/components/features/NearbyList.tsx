...
export function NearbyList({
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 z-30 max-h-[50vh] bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 rounded-t-3xl shadow-2xl overflow-hidden flex flex-col animate-in slide-in-from-bottom duration-300">
      {/* Header */}
